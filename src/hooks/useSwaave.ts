...
import { useHotpotBarContract, useHotpotContract } from './useContract'
...
const useHotpotBar = () => {
  ...
  const sushiContract = useHotpotContract(true) // withSigner
  const barContract = useHotpotBarContract(true) // withSigner
