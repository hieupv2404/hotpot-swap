import { Currency, CurrencyAmount, JSBI, Percent, Token, TradeType, Trade as V2Trade } from '@hotpot-swap/core-sdk'
import { DAI, HOTPOT, USDC } from '../config/tokens'
...
const PERMITTABLE_TOKENS: {
  ...
  [1]: {
    ...
    [HOTPOT[1].address]: { type: PermitType.AMOUNT, name: 'HotpotSwap' },
  },
  [4]: {
    ...
    [HOTPOT[4].address]: { type: PermitType.AMOUNT, name: 'HotpotSwap' },
  },
  [3]: {
    [HOTPOT[3].address]: { type: PermitType.AMOUNT, name: 'HotpotSwap' },
  ...
  [5]: {
    [HOTPOT[5].address]: { type: PermitType.AMOUNT, name: 'HotpotSwap' },
  },
  [42]: {
    [HOTPOT[42].address]: { type: PermitType.AMOUNT, name: 'HotpotSwap' },
  },
}
