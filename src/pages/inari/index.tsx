...
import useStakeHotpotToBentoStrategy from '../../state/inari/strategies/useStakeHotpotToBentoStrategy'
...
const Inari = () => {
  ...
  useEffect(() => {
    dispatch(setStrategy(stakeHotpotToBentoStrategy))
      ...
      <Container maxWidth="5xl" className="flex flex-col gap-8 px-4 py-8">
        <div className="flex items-center gap-8">
          ...
          <div className="flex flex-col">
            ...
            <Typography>
              {i18n._(t`Take your HOTPOT and invest in various strategies with one click! Earn extra yields with BentoBox, use as
