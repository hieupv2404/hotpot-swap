...
const TOOLS = (i18n: I18n) => [
  {
    id: 1,
    name: 'MEOWSHI',
    description: i18n._(t`Redenominate xHOTPOT into MEOWSHI`),
    href: '/tools/meowshi',
  },
  {
    id: 2,
    name: 'INARI',
    description: 'Deposit HOTPOT in various strategies & platforms in one click!',
    href: '/inari',
  },
]
...
export default function Tools() {
  ...
  return (
    <Container id="tools-page" className="py-4 space-y-4 md:py-8 lg:py-12" maxWidth="xl">
      <Head>
        <title>Tools | Hotpot</title>
        <meta key="description" name="description" content="HotpotSwap tools..." />
      </Head>
