import { CHAINLINK_ORACLE_ADDRESS, Currency, KASHI_ADDRESS } from '@hotpot-swap/core-sdk'
...
function Create() {
  ...
  return (
    <>
      <Head>
        <title>Create Lending Pair | Kashi by Hotpot</title>
        <meta key="description" name="description" content="Create Lending Pair on Kashi by Hotpot" />
      </Head>
      <Card
