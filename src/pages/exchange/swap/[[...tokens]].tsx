import { ChainId, Currency, CurrencyAmount, JSBI, Token, TradeType, Trade as V2Trade } from '@hotpot-swap/core-sdk'
...
export default function Swap() {
  ...
  return (
    <Container id="swap-page" className="py-4 md:py-8 lg:py-12">
      <Head>
        <title>{i18n._(t`HotpotSwap`)} | Hotpot</title>
        <meta
          key="description"
          name="description"
          content="HotpotSwap allows for swapping of ERC20 compatible tokens across multiple networks"
        />
      </Head>
      <TokenWarningModal
