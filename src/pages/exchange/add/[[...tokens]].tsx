...
import { Currency, CurrencyAmount, Percent, WNATIVE, currencyEquals } from '@hotpot-swap/core-sdk'
...
export default function Add() {
  ...
  return (
    <>
      <Head>
        <title>Add Liquidity | Hotpot</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the HotpotSwap AMM to enable gas optimised and low slippage trades across countless networks"
        />
      </Head>
