      ...
      <div className="relative w-full h-full overflow-hidden rounded bg-dark-900">
        <div className="flex flex-col gap-3 p-4">
          <div className="flex flex-row justify-between">
            <div className="font-bold text-white">{i18n._(t`Claimable HOTPOT from Protocols`)}</div>
            <QuestionHelper text="If you participated in staking progammes from Alpha Homora, Cream, DefiDollar, Dracula, Harvest, Pickle, Yam, or Badger you can claim your vested HOTPOT directly here" />
          </div>
          ...
          <div className="flex flex-col items-baseline pb-4">
            ...
            {account ? (
              <div className="text-sm text-secondary">
                {totalLocked ? (
                  i18n._(t`Historical Total Locked: ${formatNumber(totalLocked)} HOTPOT`)
                ) : (
          ...
          >
            {pendingTreasurySignature ? (
              ...
              <> {claimConfirmed ? i18n._(t`Claimed`) : i18n._(t`Claim HOTPOT`)}</>
            )}
  ...
  return (
    <div className="flex flex-col gap-3 md:max-w-[400px]">
      <div className="relative w-full h-full overflow-hidden rounded bg-dark-900">
        <div className="flex flex-col gap-3 p-4">
          <div className="flex flex-row justify-between">
            <div className="font-bold text-white">{i18n._(t`Your Claimable HOTPOT this Week`)}</div>
            <QuestionHelper text="Your Vested HOTPOT will be released each week for the next 6 months. The amount released each week is determined by your historical farming rewards. You do not need to harvest each week as unclaimed amounts from each week will continue to accrue onto the next." />
          </div>
          {/* <div style={{ display: 'flex', alignItems: 'baseline' }}> */}
          <div className="flex flex-col items-baseline pb-4">
            <div className="font-bold text-white text-[36px]">
