...
import { useBlock, useNativePrice, useHotpotPairs, useTransactions } from '../../../services/graph'
...
export default function Pair() {
  ...
  const pair = useHotpotPairs({ chainId, variables: { where: { id } } })?.[0]
  const pair1d = useHotpotPairs({ chainId, variables: { block: block1d, where: { id } }, shouldFetch: !!block1d })?.[0]
  const pair2d = useHotpotPairs({ chainId, variables: { block: block2d, where: { id } }, shouldFetch: !!block2d })?.[0]
        ...
        <div className="items-center -mt-4 space-y-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <div className="text-xs text-secondary">Hotpot Liquidity Pool</div>
            </div>
