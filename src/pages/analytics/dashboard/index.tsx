...
import { useBlock, useNativePrice, useHotpotPairs, useTokens } from '../../../services/graph'
...
export default function Dashboard(): JSX.Element {
  ...
  const pairs1d = useHotpotPairs({ chainId, variables: { block: block1d }, shouldFetch: !!block1d })
  const pairs1w = useHotpotPairs({ chainId, variables: { block: block1w }, shouldFetch: !!block1w })
      ...
      farms
        ?.map((farm) => ({
          pair: {
            ...
            type: farm.pair.symbol ? 'Kashi Farm' : 'Hotpot Farm',
          },
    ...
    <AnalyticsContainer>
      <Background background="dashboard">
        <div className="grid items-center justify-between grid-cols-2">
          <div>
            <div className="text-3xl font-bold text-high-emphesis">Hotpot Analytics</div>
            <div className="">
