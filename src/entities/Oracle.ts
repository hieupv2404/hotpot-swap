import { CHAINLINK_ORACLE_ADDRESS, ChainId, Token } from '@hotpot-swap/core-sdk'
...
export class HotpotSwapTWAP0Oracle extends AbstractOracle {
  constructor(pair, chainId: ChainId, tokens?: Token[]) {
    super(pair, chainId, tokens)
    this.name = 'HotpotSwap'
  }
}

export class HotpotSwapTWAP1Oracle extends AbstractOracle {
  constructor(pair, chainId: ChainId, tokens?: Token[]) {
    super(pair, chainId, tokens)
    this.name = 'HotpotSwap'
  }
