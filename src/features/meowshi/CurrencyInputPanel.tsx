        ...
        <div className="flex flex-col justify-between p-5 space-y-3 sm:space-y-0 sm:flex-row">
          <div className="flex items-center w-full sm:w-2/5">
            <div className="flex items-center gap-4">
              <Image
                src={
                  currency === HOTPOT[ChainId.ETHEREUM]
              ...
              <div className="flex flex-col items-start">
                ...
                {(currency === HOTPOT[ChainId.ETHEREUM] || currency === XHOTPOT) && (
                  <Typography
                    variant="xs"
                    className="underline cursor-pointer text-blue"
                    onClick={() => setCurrency(currency === XHOTPOT ? HOTPOT[ChainId.ETHEREUM] : XHOTPOT, field)}
                  >
                    {currencies[field] === HOTPOT[ChainId.ETHEREUM] ? i18n._(t`Use xHOTPOT`) : i18n._(t`Use HOTPOT`)}
                  </Typography>
                )}
              </div>
            </div>
