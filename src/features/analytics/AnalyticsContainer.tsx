...
export default function AnalyticsContainer({ children }): JSX.Element {
  return (
    <>
      <Head>
        <title>HotpotSwap Liquidity Pair (SLP) Analytics | Hotpot</title>
        <meta name="description" content="HotpotSwap Liquidity Pair (SLP) Analytics by Hotpot" />
      </Head>
