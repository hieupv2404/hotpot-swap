...
import { ChainId, Currency, Token, WNATIVE } from '@hotpot-swap/core-sdk'
...
export const CUSTOM_BASES: {
  ...
  [ChainId.MATIC]: {
    [MATIC.TEL.address]: [MATIC.HOTPOT, MATIC.AAVE],
  },
}
...
export const COMMON_BASES: ChainTokenList = {
  [ChainId.ETHEREUM]: [...WRAPPED_NATIVE_ONLY[ChainId.ETHEREUM], DAI, USDC, USDT, WBTC, OHM, HOTPOT[ChainId.ETHEREUM]],
  [ChainId.MATIC]: [
...
export const PINNED_PAIRS: {
  ...
  [ChainId.ETHEREUM]: [
    [HOTPOT[ChainId.ETHEREUM], WNATIVE[ChainId.ETHEREUM]],
    [
