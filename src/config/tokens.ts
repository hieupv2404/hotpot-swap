import { ChainId, Ether, HOTPOT_ADDRESS, Token, WETH9, WNATIVE } from '@hotpot-swap/core-sdk'
...
export const MATIC: { [key: string]: Token } = {
  ...
  HOTPOT: new Token(ChainId.MATIC, '0x0b3F868E0BE5597D5DB7fEB59E1CADBb0fdDa50a', 18, 'HOTPOT', 'HotpotToken'),
...
export const XHOTPOT_CALL = new Token(
  ChainId.ETHEREUM,
  '0xada279f9301C01A4eF914127a6C2a493Ad733924',
  18,
  'XSUc25-0531',
  'XHOTPOT 25 Call [31 May 2021]'
)
...
export const CRXHOTPOT = new Token(
  ChainId.ETHEREUM,
...
export const AXHOTPOT = new Token(
  ChainId.ETHEREUM,
  '0xF256CC7847E919FAc9B808cC216cAc87CCF2f47a',
  18,
  'aXHOTPOT',
  'Aave interest bearing XHOTPOT'
)
...
export const HOTPOT: ChainTokenMap = {
  [ChainId.ETHEREUM]: new Token(ChainId.ETHEREUM, HOTPOT_ADDRESS[ChainId.ETHEREUM], 18, 'HOTPOT', 'HotpotToken'),
  ...
  [ChainId.CELO]: new Token(ChainId.CELO, HOTPOT_ADDRESS[ChainId.CELO], 18, 'HOTPOT', 'HotpotToken'),
  [ChainId.MOONRIVER]: new Token(ChainId.MOONRIVER, HOTPOT_ADDRESS[ChainId.MOONRIVER], 18, 'HOTPOT', 'HotpotToken'),
  [ChainId.TELOS]: new Token(ChainId.TELOS, HOTPOT_ADDRESS[ChainId.TELOS], 18, 'HOTPOT', 'HotpotToken'),
}
