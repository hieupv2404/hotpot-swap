import { ChainId, Currency, NATIVE, HOTPOT_ADDRESS } from '@hotpot-swap/core-sdk'
            ...
            <div className="px-4 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <Image src="/logo.png" alt="Hotpot" width="32px" height="32px" />
                ...
                <div className="fixed bottom-0 left-0 z-10 flex flex-row items-center justify-center w-full p-4 lg:w-auto bg-dark-1000 lg:relative lg:p-0 lg:bg-transparent">
                  <div className="flex items-center justify-between w-full space-x-2 sm:justify-end">
                    {chainId && [ChainId.ETHEREUM].includes(chainId) && library && library.provider.isMetaMask && (
                      <>
                        <QuestionHelper text={i18n._(t`Add xHOTPOT to your MetaMask wallet`)}>
                          <div
                            ...
                            onClick={() => {
                              if (library && library.provider.isMetaMask && library.provider.request) {
                                ...
                                library.provider
                                  ...
                                  .then((success) => {
                                    if (success) {
                                      console.log('Successfully added XHOTPOT to MetaMask')
                                    } else {
                    ...
                    {chainId && chainId in HOTPOT_ADDRESS && library && library.provider.isMetaMask && (
                      <>
                        <QuestionHelper text={i18n._(t`Add HOTPOT to your MetaMask wallet`)}>
                          <div
                            ...
                            onClick={() => {
                              const params: any = {
                                type: 'ERC20',
                                options: {
                                  address: HOTPOT_ADDRESS[chainId],
                                  symbol: 'HOTPOT',
                                  decimals: 18,
                                  image:
                                    'https://raw.githubusercontent.com/Hotpot-Swap/hotpot-swap-interface/master/public/android-chrome-128x128.png',
                              ...
                              if (library && library.provider.isMetaMask && library.provider.request) {
                                library.provider
                                  ...
                                  .then((success) => {
                                    if (success) {
                                      console.log('Successfully added HOTPOT to MetaMask')
                                    } else {
                                      throw new Error('Something went wrong.')
                                    }
                                  })
