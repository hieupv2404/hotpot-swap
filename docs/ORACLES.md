...
Currently there is two types of oracles which the sushi interface supports, Chainlink & HotpotSwap TWAP.
...
Each price feed has a pair token0/token1, HOTPOT/ETH or HOTPOT/USD for example, decimals, and proxy. We use this information to construct mappings of the price feed to their respectful pair tokens.
